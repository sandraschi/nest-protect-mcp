<#
.SYNOPSIS
    Build script for creating the Nest-Protect-MCP DXT package.
.DESCRIPTION
    This script automates the process of creating a DXT package for the Nest-Protect-MCP project.
...
try {
    ...
    Write-Host "3. The Nest Protect MCP server should start automatically"
