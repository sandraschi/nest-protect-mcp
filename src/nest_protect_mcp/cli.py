...
class NestProtectCLI:
    ...
    def _print_device_details(self, device: ProtectDeviceState) -> None:
        ...
        info = [
            ...
            [
                "Temperature",
                f"{device.temperature}°C" if device.temperature is not None else "N/A",
            ],
            [
                "Humidity",
                f"{device.humidity}%" if device.humidity is not None else "N/A",
            ],
            ...
            [
                "Last Connection",
                device.last_connection.isoformat() if device.last_connection else "N/A",
            ],
            [
                "Last Test",
