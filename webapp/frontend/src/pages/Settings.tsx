    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Status:{" "}
            {serverOk === true ? "Connected" : serverOk === false ? "Disconnected" : "Checking…"}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
      ...
      {serverOk && (
        <Card>
          ...
          <CardContent className="text-sm text-gray-600 dark:text-gray-400">
            <p>
              The MCP server is reachable. Use the <strong>MCP Status</strong> page for detailed
              health data, or the <strong>Device Testing</strong> page to interact with Nest Protect
              units.
            </p>
          </CardContent>
        </Card>
