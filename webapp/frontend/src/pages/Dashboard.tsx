...
export default function Dashboard() {
  const [serverStatus, setServerStatus] = useState<"connected" | "disconnected" | "connecting">(
    "connecting",
  );
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto text-center mb-8 leading-relaxed">
          FastMCP 2.14.3 Testing Suite - Experience conversational AI, sampling capabilities, and
          intelligent device orchestration for next-generation smart home safety.
        </p>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center justify-center mb-4">
                  <div
                    className={`p-3 rounded-full ${action.color} group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <Button asChild className="w-full">
                  <Link to={action.link}>Open {action.title}</Link>
                </Button>
              </CardContent>
            </Card>
          ))}
        ...
        <Card className="text-center border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
          <CardContent className="p-6">
            ...
            <p className="text-blue-700 dark:text-blue-300 text-sm">
              Experience natural language responses with contextual suggestions and follow-up
              questions
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="text-center border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900">
          <CardContent className="p-6">
            ...
            <div className="flex items-center justify-center mb-2">
              <span className="text-lg font-semibold text-purple-800 dark:text-purple-200 mr-2">
                Sampling
              </span>
