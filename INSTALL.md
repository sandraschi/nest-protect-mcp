...
4. Start the server:
   ...
   uv run python -m nest_protect_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn nest_protect_mcp.server:app --port 10829
   ```
...
5. Open `http://localhost:10829` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/nest-protect-mcp/issues) |
