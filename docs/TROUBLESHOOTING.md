...
**Framework**: FastMCP 3.1 (upgraded from 2.12/2.13)  
**Status**: **PRODUCTION READY**

For **auth and refresh token** issues, see [AUTH_SETUP.md](AUTH_SETUP.md) first. This guide documents the debugging journey from earlier FastMCP versions and general troubleshooting.
